  ...
  return (
    <div className="min-h-screen bg-[#070913] flex items-center justify-center text-white">
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm font-medium text-gray-300">Loading HiChat Vault...</span>
      </div>
    </div>
  );
}
...
const Navigation = React.memo(function Navigation({ isLoggedIn, username, onLogout }) {
...
// Layout wrapper with granular selectors
function MainLayout() {
  const location = useLocation();
